...
let Unlock = parseInt(localStorage.getItem('Complete6'), 10);
...
function preload() {
  ...
  for (let i = 1; i <= 3; i++) {
    images.push(loadImage("materials/levels/Lvl_B" + i + ".6.jpg"));
    ...
    loadImage("materials/images/Hint_3.png");
...
function setup() {
  ...
  Complete = createImg("materials/notifications/Completion6.png", "completeImg");
...
function papirosImgClicked() {
  ...
  if (!hintBackground) {
    ...
    dynamicImage = createImg("materials/images/Hint_3.png", "dynamic-image");
